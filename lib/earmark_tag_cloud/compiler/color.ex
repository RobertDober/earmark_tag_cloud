defmodule EarmarkTagCloud.Compiler.Color do
  ...
  @doc """
  Compute gamma correction for an int in the byte range expressed as a hex string

  e.g.

      iex(0)> gamma_corrected_octet(0, "00")
      "ff"

      iex(0)> gamma_corrected_octet(12, "00")
      "00"

      iex(0)> gamma_corrected_octet(12, "ff")
      "ff"

      iex(0)> gamma_corrected_octet(10, "f0")
      "e9"
  """
  @spec gamma_corrected_octet(integer(), binary()) :: binary()
